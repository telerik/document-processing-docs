...
You need to get and install a new license key after starting a trial, renewing a license, or upgrading a license.
...
* _Perpetual licenses_ will continue to function normally with an expired license key. However, the following happens if you update or install a package version released after the expiration date of the license:
...
If both the TELERIK\_LICENSE environment variable and the _telerik-license.txt_ file are present, then the environment variable is used.
