...
title: Features
page_title: Features
description: Learn about all the features supported by DocFormatProvider for importing DOC and DOT files in RadWordsProcessing.
...
The following table lists all features supported by `DocFormatProvider`.
