...
* **NormalIconSource**: [FormSource]({%slug radpdfprocessing-sample-test%}) that is used for drawing a button icon when the mouse is not interacting with widget.

* **MouseOverIcon**: [FormSource]({%slug radpdfprocessing-sample-test%}) that is used for drawing a button icon when the mouse is over the widget.

* **MouseDownIcon**: [FormSource]({%slug radpdfprocessing-sample-test%}) that is used for drawing a button icon when the mouse is pressed on the widget.
