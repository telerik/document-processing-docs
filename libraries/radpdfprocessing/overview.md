...
**RadPdfProcessing** is the PDF library in Telerik Document Processing. Use it to create, import, edit, and export PDF documents in .NET applications. You can generate PDF files from code, work with existing documents, and add forms, tables, annotations, digital signatures, accessibility metadata, and more without relying on Adobe Acrobat or other third-party desktop software.
...
>note If you still need to install Telerik Document Processing, see [first steps with Telerik Document Processing]({%slug getting-started-first-steps%}) for the available package options.
...
| Feature | Description |
|---|---|
| Create and edit PDF documents | Generate documents from scratch, import supported PDF content, or append new content. |
...
`RadPdfProcessing` provides two editors for different document-generation styles:
...
| [Images]({%slug radpdfprocessing-model-image%}) | Work with encoded image data, control image quality, and use supported image and form-source types. |
...
| Password protection | [Import encrypted documents]({%slug radpdfprocessing-formats-and-conversion-pdf-settings%}#import-settings) and [export password-protected documents]({%slug radpdfprocessing-formats-and-conversion-pdf-settings%}#export-settings) with supported algorithms. |
...
* [Install Telerik Document Processing]({%slug installation-installing-on-your-computer%})
* [Start with Telerik Document Processing]({%slug getting-started-first-steps%})
* [Get started with RadPdfProcessing]({%slug radpdfprocessing-getting-started%})
* [Use PdfFormatProvider]({%slug radpdfprocessing-formats-and-conversion-pdf-pdfformatprovider%})
* [Create accessible PDF documents]({%slug create-accessible-pdf-documents%})
