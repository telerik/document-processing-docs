...
description: Learn how to generate concise summaries of Excel spreadsheet documents using the SummarizationProcessor class and Large Language Models in RadSpreadProcessing.
...
|---|---|
|`Settings`|Gets the settings that the processor uses for summarization.|
