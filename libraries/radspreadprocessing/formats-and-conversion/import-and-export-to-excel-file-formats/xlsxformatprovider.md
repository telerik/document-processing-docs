...
tags: using,xlsxformatprovider,excel
published: True
position: 2
---
...
__XlsxFormatProvider__ makes it easy to import and export Excel xlsx files. An xlsx file is a group of zipped files that conform to the Office Open XML schema. That said, the format allows you export all parts of a workbook: worksheets, formula values, formatting, hyperlinks, etc.
...
#### __[C#] Example 1: Import Excel xlsx file__
...
#### __[C#] Example 2: Export spreadsheet document to Excel xlsx file__
